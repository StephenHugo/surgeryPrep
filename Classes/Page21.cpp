...
Scene* Page21::createScene() {
	auto scene = Scene::create();
	auto layer = Page21::create();
...
bool Page21::init() {
	...
	// add splash screen"
	auto sprite = Sprite::create(PAGE21);
	...
	this->scheduleOnce(schedule_selector(Page21::gotoNextScene), LAUNCHTRANSITIONTIME);
...
void Page21::gotoNextScene(float dt)
{
	auto nextScene = Page22::createScene();
