...
Scene* Page19::createScene() {
	auto scene = Scene::create();
	auto layer = Page19::create();
...
bool Page19::init() {
	...
	// add splash screen"
	auto sprite = Sprite::create(PAGE19);
	...
	this->scheduleOnce(schedule_selector(Page19::gotoNextScene), LAUNCHTRANSITIONTIME);
...
void Page19::gotoNextScene(float dt)
{
	auto nextScene = Page20::createScene();
