...
Scene* Page13::createScene() {
	auto scene = Scene::create();
	auto layer = Page13::create();
...
bool Page13::init() {
	...
	// add splash screen"
	auto sprite = Sprite::create(PAGE13);
	...
	this->scheduleOnce(schedule_selector(Page13::gotoNextScene), LAUNCHTRANSITIONTIME);
...
void Page13::gotoNextScene(float dt)
{
	auto nextScene = Page14::createScene();
