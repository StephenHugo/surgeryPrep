...
bool Page6::init() {
	...
	// add splash screen"
	auto sprite = Sprite::create(PAGE6);
	...
	this->scheduleOnce(schedule_selector(Page6::gotoNextScene), LAUNCHTRANSITIONTIME);
...
void Page6::gotoNextScene(float dt)
{
	auto nextScene = Page7::createScene();
