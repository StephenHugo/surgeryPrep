...
Scene* Page17::createScene() {
	auto scene = Scene::create();
	auto layer = Page17::create();
...
bool Page17::init() {
	...
	// add splash screen"
	auto sprite = Sprite::create(PAGE17);
	...
	this->scheduleOnce(schedule_selector(Page17::gotoNextScene), LAUNCHTRANSITIONTIME);
...
void Page17::gotoNextScene(float dt)
{
	auto nextScene = Page18::createScene();
