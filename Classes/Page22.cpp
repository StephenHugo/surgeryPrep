...
Scene* Page22::createScene() {
	auto scene = Scene::create();
	auto layer = Page22::create();
...
bool Page22::init() {
	...
	// add splash screen"
	auto sprite = Sprite::create(PAGE22);
	...
	this->scheduleOnce(schedule_selector(Page22::gotoNextScene), LAUNCHTRANSITIONTIME);
...
void Page22::gotoNextScene(float dt)
{
	auto nextScene = Page23::createScene();
