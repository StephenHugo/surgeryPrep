...
Scene* Page11::createScene() {
	auto scene = Scene::create();
	auto layer = Page11::create();
...
bool Page11::init() {
	...
	// add splash screen"
	auto sprite = Sprite::create(PAGE11);
	...
	this->scheduleOnce(schedule_selector(Page11::gotoNextScene), LAUNCHTRANSITIONTIME);
...
void Page11::gotoNextScene(float dt)
{
	auto nextScene = Page12::createScene();
