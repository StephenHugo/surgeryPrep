...
Scene* Page8::createScene() {
	auto scene = Scene::create();
	auto layer = Page8::create();
...
bool Page8::init() {
	...
	// add splash screen"
	auto sprite = Sprite::create(PAGE8);
	...
	this->scheduleOnce(schedule_selector(Page8::gotoNextScene), LAUNCHTRANSITIONTIME);
...
void Page8::gotoNextScene(float dt)
{
	auto nextScene = Page9::createScene();
