...
Scene* Page25::createScene() {
	auto scene = Scene::create();
	auto layer = Page25::create();
...
bool Page25::init() {
	...
	// add splash screen"
	auto sprite = Sprite::create(PAGE25);
	...
	this->scheduleOnce(schedule_selector(Page25::gotoNextScene), LAUNCHTRANSITIONTIME);
...
void Page25::gotoNextScene(float dt)
{
	auto nextScene = Page26::createScene();
