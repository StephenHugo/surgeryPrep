...
Scene* Page14::createScene() {
	auto scene = Scene::create();
	auto layer = Page14::create();
...
bool Page14::init() {
	...
	// add splash screen"
	auto sprite = Sprite::create(PAGE14);
	...
	this->scheduleOnce(schedule_selector(Page14::gotoNextScene), LAUNCHTRANSITIONTIME);
...
void Page14::gotoNextScene(float dt)
{
	auto nextScene = Page15::createScene();
