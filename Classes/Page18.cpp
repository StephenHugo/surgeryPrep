...
Scene* Page18::createScene() {
	auto scene = Scene::create();
	auto layer = Page18::create();
...
bool Page18::init() {
	...
	// add splash screen"
	auto sprite = Sprite::create(PAGE18);
	...
	this->scheduleOnce(schedule_selector(Page18::gotoNextScene), LAUNCHTRANSITIONTIME);
...
void Page18::gotoNextScene(float dt)
{
	auto nextScene = Page19::createScene();
