...
Scene* Page16::createScene() {
	auto scene = Scene::create();
	auto layer = Page16::create();
...
bool Page16::init() {
	...
	// add splash screen"
	auto sprite = Sprite::create(PAGE16);
	...
	this->scheduleOnce(schedule_selector(Page16::gotoNextScene), LAUNCHTRANSITIONTIME);
...
void Page16::gotoNextScene(float dt)
{
	auto nextScene = Page17::createScene();
