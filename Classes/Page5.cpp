...
bool Page5::init() {
	...
	// add splash screen"
	auto sprite = Sprite::create(PAGE5);
	...
	this->scheduleOnce(schedule_selector(Page5::gotoNextScene), LAUNCHTRANSITIONTIME);
...
void Page5::gotoNextScene(float dt)
{
	auto nextScene = Page6::createScene();
