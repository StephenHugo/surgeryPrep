...
Scene* Page26::createScene() {
	auto scene = Scene::create();
	auto layer = Page26::create();
...
bool Page26::init() {
	...
	// add splash screen"
	auto sprite = Sprite::create(PAGE26);
	...
	this->scheduleOnce(schedule_selector(Page26::gotoNextScene), LAUNCHTRANSITIONTIME);
...
void Page26::gotoNextScene(float dt)
{
