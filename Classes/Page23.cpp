...
Scene* Page23::createScene() {
	auto scene = Scene::create();
	auto layer = Page23::create();
...
bool Page23::init() {
	...
	// add splash screen"
	auto sprite = Sprite::create(PAGE23);
	...
	this->scheduleOnce(schedule_selector(Page23::gotoNextScene), LAUNCHTRANSITIONTIME);
...
void Page23::gotoNextScene(float dt)
{
	auto nextScene = Page24::createScene();
